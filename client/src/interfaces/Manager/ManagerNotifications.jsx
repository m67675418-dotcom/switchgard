...
// Notification.type → which bucket it belongs to in the history view.
// Prefer the backend-set `status` field (set when a manager approves/rejects
// a director_review notification); fall back to type-based inference for
// notification types that never carry a meaningful status (final_approved,
// final_rejected, demande_rejected) or for older records saved before the
