...
app.use('/api/account/admin',       require('./routes/accountRoutes/adminRegister'));
app.use('/api/account/create',      require('./routes/accountRoutes/createAccount'));
app.use('/api/account',             require('./routes/accountRoutes/getAccounts'));
app.use('/api/account',             require('./routes/accountRoutes/deleteAccount'));
app.use('/api/account',             require('./routes/accountRoutes/updateAccount'));
app.use('/api/account/userProfile', require('./routes/accountRoutes/getUserProfile'));
...
app.use('/api/email',      require('./routes/emailHandlers/GetAllEmails'));
...
// ── Facility Routes ──
app.use('/api/facility', require('./routes/facilityRoutes/getFacilities'));
app.use('/api/facility', require('./routes/facilityRoutes/setLocation'));
